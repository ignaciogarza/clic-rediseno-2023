...
/* function fnSignOut(email){
	...
	location.href= "/login/signOut0102?email="+email;
} */
		...
		<div class="inner">
			<div class="logo-wrap">
				<div class="logo-bottom">
					<a href="/main"><span>Clic</span><spring:message code="menu10" text="Observatory"/></a>
				</div>
			</div>
			<div class="footer-util">
				<ul class="policy-list">
					<li class="dashboard"><a href="javascript:;" onclick="fnSignOut('${sessionScope.sessionEmail}');">Clic</a></li> 
