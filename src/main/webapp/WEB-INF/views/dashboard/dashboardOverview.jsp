...
<head>
	...
	<script>
		...
		function fnTabMenuClick(type){
			$("#miembro").removeClass("on");
			$("#tomar").removeClass("on");
			$("#aprobar").removeClass("on");
			$("#reanudar").removeClass("on");
			$("#portafolio").removeClass("on");
			...
			if(type == "M"){
				...
				$("#reanudar").addClass("on");
			}else if(type == "P"){
				$("#portafolio").addClass("on");
			}
		...
		function showMarker(path, text, top, left){
			if(currentPath==path){
				...
				currentPath = path;
				//도시별로 값 넘겨서 조회 처리 해야함   text값이 아이디이니깐 이값으로 val값 세팅해야함
				getList(text);
			}
		}
		...
		function getList(cityText){
		    ...
		    $.ajax({
		        ...
		        dataType : 'json', 
		        data : data,
		        url : '/dashboard/getStcCodeMemberList',
		        success : function(response) {
					...
					//회원
					$("#miembroNumber").text(addComma(result.userCnt));    
					  
					//테스트응시
					$("#tomarNumber").text(addComma(result.skillStcTotalCnt)); 
					  
					//테스트통과
					$("#aprobarNumber").text(addComma(result.skillStcPassCnt)); 
					//$("#aprobarNumber").text("100000"); 
					  
					//이력서
					$("#reanudarNumber").text(addComma(result.resumeCnt)); 
					  
					//포트폴리오
					$("#portafolioNumber").text(addComma(result.portfolioCnt)); 
...
<body>
	<div class="wrapper gvm-wrapper gvm-login"><!-- // 정부회원 로그인시 클래스 .gvm-login 추가 (로그아웃 또는 일반회원 로그인시 클래스 삭제) -->
		...
		<div id="container">
			<article id="content">
				<h2 class="title1 mt-0 d-down-md">Visión general</h2>
				<div class="gv-area overview-area">
					...
					<nav class="tab-menu">
						<ul class="tab-list">
							<input type="hidden" id="tabMenuVal" value="M">
							<li id="miembro" class="on">
								<a href="#;" onclick="fnTabMenuClick('M')">
									<div class="info-area">
										<span class="title"><spring:message code="dashboard.text1" text="Miembro" /></span>
										<span class="number" id="miembroNumber">0</span>
									</div>
								</a>
							</li>
							<li id="tomar">
								<a href="#;" onclick="fnTabMenuClick('T')">
									<div class="info-area">
										<span class="title"><spring:message code="dashboard.text2" text="Tomar el examen" /></span>
										<span class="number" id="tomarNumber">0</span>
									</div>
								</a>
							</li>
							<li id="aprobar">
								<a href="#;" onclick="fnTabMenuClick('A')">
									<div class="info-area">
										<span class="title"><spring:message code="dashboard.text4" text="Aprobar el examen" /></span>
										<span class="number" id="aprobarNumber">0</span>
									</div>
								</a>
							</li>
							<li id="reanudar">
								<a href="#;" onclick="fnTabMenuClick('R')">
									<div class="info-area">
										<span class="title"><spring:message code="dashboard.text6" text="Reanudar" /></span>
										<span class="number" id="reanudarNumber">0</span>
									</div>
								</a>
							</li>
							<li id="portafolio">
								<a href="#;" onclick="fnTabMenuClick('P')">
									<div class="info-area">
										<span class="title"><spring:message code="dashboard.text7" text="Portafolio" /></span>
										<span class="number" id="portafolioNumber">0</span>
									</div>
								</a>
							</li>
						</ul>
							...
							<div class="detail-state">
								<div class="content-row">
									<div class="box-state box-state1">
										...
										<%-- <div class="chart-area"><p class="dummy" style="line-height: 188px; text-align: center;"><canvas id="Genero_Canvas" ></canvas></p><!-- // 해당 라인 삭제 후 개발 --></div> --%>
								...
								<div class="content-row">
									<div class="box-state box-state3">
										...
										<%-- <div class="chart-area"><p class="dummy" style="line-height: 188px; text-align: center;"><canvas id="Educacion_Canvas" ></canvas></p><!-- // 해당 라인 삭제 후 개발 --></div> --%>
										<div class="gv-chart">
											<div class="chart-inner">
												<div class="chart-area"><br/>
								...
								<div class="content-row">
									<div class="box-state box-state5">
										...
										<%-- <div class="chart-area"><p style="line-height: 208px; text-align: center;"><canvas id="Sectores_Canvas" ></canvas></p><!-- // 해당 라인 삭제 후 개발 --></div> --%>
										<div class="gv-chart">
											<div class="chart-inner">
