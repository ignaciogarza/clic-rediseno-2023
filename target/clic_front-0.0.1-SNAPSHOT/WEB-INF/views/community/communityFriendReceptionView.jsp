...
<head>
	...
	function search(page){
		...
		$.ajax({
	        ...
	        dataType : 'json', 
	        data : data,
	        url : '/community/communityFriendReceptionList',
	        success : function(response) {
	          ...
	          if(list != null && list.length > 0){	
	        	  ...
	        	  for (var i = 0; i < list.length; i++) {						
	        		  <!-- 친구 목록이 있을 경우 -->	        		 
	        		  html += '	<div class="box">';
	        		  html += '		<span class="date">'+list[i].updatedDate+'</span>';
	        		  html += '		<div class="item">';
	        		  ...
	        		  html += '				<button type="button" class="btn btn-approve" onclick="fuApprovalFriend(\''+list[i].userId+'\')"><spring:message code="button.accept" text=""/></button>';
	        		  html += '				<button type="button" class="btn btn-cancle" onclick="fuRejectFriend(\''+list[i].userId+'\')"><spring:message code="button.cancel" text=""/></button>';
	        		  html += '			</div>';
	        		  html += '		</div>';
	        		  html += '	</div>';
	          ...
	          html += '</div>';
	          $("#fridndReceptionForm").append(html);
