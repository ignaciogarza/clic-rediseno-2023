...
<head>
	...
	function search(page){
		...
		$.ajax({
	        ...
	        dataType : 'json', 
	        data : data,
	        url : '/community/communitySkillAllList',
	        success : function(response) {
	          ...
	          //메인 상단 탑 데이터 세팅 
	          $("#allTotal").text('<spring:message code="community.text11" text="Verificación Completada"/> ('+resultList.allTotal+')');
	          $("#allTotalDown").text(resultList.allTotal);
	          
	          $("#receptionTotal").text('<spring:message code="community.text13" text="Autenticación Enviada"/> ('+resultList.receptionTotal+')');
	          $("#receptionTotalDown").text(resultList.receptionTotal);
	          
	          $("#sendTotal").text('<spring:message code="community.text12" text="Certificación Recibida"/> ('+resultList.sendTotal+')');
	          ...
	          if(list != null && list.length > 0){	
	        	  ...
	        	  for (var i = 0; i < list.length; i++) {						
	        		  ...
	        		  html += '			</div>';
	        		  html += '			<span class="date-info">'+list[i].updatedDate+'</span>';
	        		  html += '		</div>';
	        		  html += '	</div>';
				  }
	        	  html += '</div>';
			...
			<article id="content">
				...
				<div class="content-fixed community-total">
					...
					<div class="content-body style2">
						...
						<div class="tab-content" id="skillAllForm">
