			...
			<div class="question-area">
				...
				<div class="item">
					...
					<form id="answerForm">
						...
						<input type="hidden" id="answerTest" value="answerTest">
						<%-- <c:set var="shortAnswer" value=""/>
						<c:if test="${not empty data.answer}">
							<c:set var="shortAnswer" value="${data.answer.shortAnswer}"/>
						</c:if>
						<dl class="subjective-answer">
							<dt><spring:message code="evaluate.question.answer" text="Respuesta" /></dt>
							<dd>
								<textarea rows="4" class="form-control full" name="shortAnswer" maxlength="600">${shortAnswer}</textarea>
							</dd>
						</dl> --%>
					</form>
				</div>
