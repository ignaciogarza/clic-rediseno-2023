			...
			<div class="question-area">
				...
				<div class="item">
					...
					<form id="answerForm">
						...
						<input type="hidden" id="choiceTest" value="choiceTest">
						<ul class="answer-list choice">
							<%-- <c:forEach items="${data.exampleList1}" var="item">
								<li class="check-item">
									<input type="radio" name="exampleAnswer" id="input_${item.exampleNumber}" value="${item.exampleNumber}">
									<label for="input_${item.exampleNumber}">
										...
										<c:if test="${not empty item.exampleImagePath}">
											<span class="answer-image">
												<img src="${item.exampleImagePath}" alt="">
											</span>
										</c:if>
									</label>
								</li>
