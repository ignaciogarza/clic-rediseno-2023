			...
			<div class="question-area">
				...
				<div class="item">
					...
					<form id="answerForm">
						...
						<input type="hidden" id="scaleTest" value="scaleTest">
						<%-- <c:set var="len" value="${fn:length(data.exampleList1)}"/>
						<div class="measure-answer label-item${len}">
							<div class="range">
								<input type="range" min="1" max="${len}" step="1" value="0" name="exampleAnswer">
							</div>
							<ul class="range-label">
								<c:forEach items="${data.exampleList1}" var="item">
									<li><span>${item.exampleContents}</span></li>
								</c:forEach>
							</ul>
						</div> --%>
					</form>
